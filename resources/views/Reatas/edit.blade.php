            ...
            <div class="px-4 py-5 bg-white sm:p-6">
              <div class="grid grid-cols-6 gap-6">
                <div class="col-span-6 sm:col-span-3">
                  ...
                  value="{{(old('nombre') ? old('nombre') : @$reata->nombre)}}"
                ...
                <div class="col-span-6 sm:col-span-3">
                  ...
                  value="{{(old('logo') ? old('logo') : @$reata->logo)}}"
                   class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                </div>
                ...
                <div class="col-span-6 sm:col-span-3">
                  ...
                  value="{{(old('color') ? old('color') : @$reata->color)}}"
                   autocomplete="color" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                </div>
                <div class="col-span-6 sm:col-span-3">
                ...
                <div class="col-span-6 sm:col-span-3">
                  ...
                  <select id="tipo" name="tipo" autocomplete="tipo" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                    <option value="CUERO" {{$reata->tipo == 'CUERO' ? 'selected': ''}}>CUERO</option>
                    <option value="TELA" {{$reata->tipo == 'TELA' ? 'selected': ''}}>TELA</option>
                    <option value="TUBULAR" {{$reata->tipo == 'TUBULAR' ? 'selected': ''}}>TUBULAR</option>
                  </select>
                </div>
                ...
                <div class="col-span-6 sm:col-span-3">
                    ...
                    <select id="genero" name="genero" autocomplete="genero" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                        <option value="HOMBRE" {{$reata->tipo == 'HOMBRE' ? 'selected': ''}}>HOMBRE</option>
                        <option value="MUJER" {{$reata->tipo == 'MUJER' ? 'selected': ''}}>MUJER</option>
                        <option value="UNISEX" {{$reata->tipo == 'UNISEX' ? 'selected': ''}}>UNISEX</option>
                    </select>
                  </div>
              </div>
            </div>
